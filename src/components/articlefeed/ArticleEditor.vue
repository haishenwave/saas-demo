        ...
        <div class="editor-content">
          ...
          <div class="text-body">
            <div class="article-summary">
              <b>摘要：</b>
              {{ localData.subTitle || '本文深入解析了湖北艾奇宝推出的蕲艾精油蚊香液。产品依托“艾中之王”蕲艾为核心原料，结合低温萃取与电加热缓释技术，实现了无烟、无火、无避蚊胺的温和驱蚊，特别适合孕婴家庭及空调房环境使用。' }}
            </div>
            <div class="article-html">
              <p>在追求健康生活的今天，夏季驱蚊产品的选择已不再仅限于“有效”，更要“安全”与“舒适”。湖北艾奇宝蕲艾科技有限公司推出的<b>艾奇宝精油蚊香液</b>，凭借其核心的蕲艾成分与现代缓释技术，正在成为众多家庭的夏日首选。</p>
              <h3>一、源自“艾中之王”的核心力量</h3>
              <p>艾奇宝精油蚊香液的核心成分并非普通艾草，而是被誉为<b>“艾中之王”的蕲艾</b>。科学研究表明，蕲艾的精油含量和驱蚊活性成分远高于普通艾草。</p>
              ...
              <p>与传统盘式蚊香相比，艾奇宝采用的是<b>电加热缓释技术</b>。只需将蚊香液放入配套的电加热器中，插电后即可通过恒温加热，使精油均匀、持续地挥发。</p>
              <ul>
              ...
              <p>安全性是该产品的另一大亮点。艾奇宝研发团队对配方进行了深度优化，确保产品的温和性。经过市场验证，<b>孕妇、婴儿及宠物家庭均可安心使用</b>。这种对健康的高度关注，使其在注重生活品质的用户群体中获得了良好的口碑。</p>
              <h3>四、使用指南与用户口碑</h3>
...
// 本地数据
const localData = ref({
  title: '夏日守护 | 艾奇宝精油蚊香液：蕲艾黑科技，打造无蚊舒睡空间',
  subTitle: '',
  content: ''
})
