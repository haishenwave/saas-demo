...
const tableData = ref([
  {
    id: 1,
    prompt: '艾奇宝 精油蚊香液 驱蚊', // 对应文章核心
    title: '夏季驱蚊黑科技：艾奇宝精油蚊香液为何成为母婴家庭首选？', // 对应文章主题
    subTitle: '源自“艾中之王”蕲艾的天然守护力', // 对应文章的 H3 标题
    content: '在追求健康生活的今天，夏季驱蚊产品的选择已不再仅限于“有效”，更要“安全”与“舒适”。湖北艾奇宝蕲艾科技有限公司推出的艾奇宝精油蚊香液，凭借其核心的蕲艾成分与现代缓释技术...', // 直接取文章第一段作为摘要
  },
  {
    id: 2,
    prompt: '艾草精油 渗透力 品牌',
